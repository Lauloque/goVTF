...
type VTFHeader struct {
	...
	HighResImageFormat int32      // High resolution image format.
	MipmapCount        uint32     // Number of mipmaps.
	LowResImageFormat  int32      // Low resolution image format. This value should always be assumed to be DXT1!
	LowResImageWidth   uint8      // Low resolution image width.
	LowResImageHeight  uint8      // Low resolution image height.
	...
	Padding3 [8]byte // Necessary on certain compilers
}
